...
- ✓ Verified all images are in Manuscript/images/ directory (v0.12.2+)
...
- **Assets must exist**: Referenced images must be in Manuscript/images/ directory (v0.12.2+)
...
- `--resource-path="Manuscript"`: Images resolved from Manuscript/images/ (v0.12.2+)
...
```bash
# Copy images to export directory (v0.12.2+ unified directory)
...
**Solutions:**
- Verify images exist in Manuscript/images/ directory (v0.12.2+)
