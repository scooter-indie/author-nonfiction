...
- ✓ Verified all images are in Manuscript/images/ directory (v0.12.4+)
...
- **Assets must exist**: Referenced images must be in Manuscript/images/ directory (v0.12.4+)
...
- `--resource-path="Manuscript"`: Images resolved from Manuscript/images/ (v0.12.4+)
...
```bash
# Copy images to export directory (v0.12.4+ unified directory)
...
**Solutions:**
- Verify images exist in Manuscript/images/ directory (v0.12.4+)
