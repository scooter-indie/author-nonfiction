...
- ✓ Verified all images are in Manuscript/images/ directory (v0.12.6+)
...
- **Assets must exist**: Referenced images must be in Manuscript/images/ directory (v0.12.6+)
...
- `--resource-path="Manuscript"`: Images resolved from Manuscript/images/ (v0.12.6+)
...
```bash
# Copy images to export directory (v0.12.6+ unified directory)
...
**Solutions:**
- Verify images exist in Manuscript/images/ directory (v0.12.6+)
