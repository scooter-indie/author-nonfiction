...
- Note: Images go in Manuscript/images/ (unified directory, v0.12.5+), not per-chapter
...
**Note:** Chapter directories NO LONGER include a figures/ subdirectory. All images for the entire book go in the unified `Manuscript/images/` directory (v0.12.5+). Use Prompt 15 (Visual Content Suggester) or Prompt 16 (Image Manager) to add images to chapters.
...
- **Images are NOT stored per-chapter** - all images go in unified `Manuscript/images/` directory (v0.12.5+)
