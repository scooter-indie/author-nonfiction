...
**For New Installations:**
```bash
git add . && git commit -m "Initialize nonfiction framework v0.13.13
...
**For Updates:**
```bash
git add . && git commit -m "Update framework to v0.13.13
...
Framework v0.13.13 installed successfully.
...
Updated from v[old] to v0.13.13
...
Solutions:
1. Re-extract nonfiction-v0.13.13.zip to this directory
