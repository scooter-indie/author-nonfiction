...
**For New Installations:**
```bash
git add . && git commit -m "Initialize nonfiction framework v0.14.0
...
**For Updates:**
```bash
git add . && git commit -m "Update framework to v0.14.0
...
Framework v0.14.0 installed successfully.
...
Solutions:
1. Re-extract nonfiction-v0.14.0.zip to this directory
