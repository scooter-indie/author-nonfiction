...
**For New Installations:**
```bash
git add . && git commit -m "Initialize nonfiction framework v0.13.12
...
**For Updates:**
```bash
git add . && git commit -m "Update framework to v0.13.12
...
Framework v0.13.12 installed successfully.
...
Updated from v[old] to v0.13.12
...
Solutions:
1. Re-extract nonfiction-v0.13.12.zip to this directory
