...
**AI-Assisted Nonfiction Authoring Framework v0.14.0**
...
Download `nonfiction-v0.14.0.zip` from:
...
tar -xf nonfiction-v0.14.0.zip
```

**macOS/Linux:**
```bash
cd /path/to/my-book
unzip nonfiction-v0.14.0.zip
```
...
```cmd
cd E:\Projects\my-book
tar -xf nonfiction-v0.14.0.zip --force-local
```

**macOS/Linux (with overwrite):**
```bash
cd /path/to/my-book
unzip -o nonfiction-v0.14.0.zip
```
