...
**AI-Assisted Nonfiction Authoring Framework v0.12.7**
...
Download `nonfiction-v0.12.7.zip` from:
...
2. Copy `nonfiction-v0.12.7.zip` into this directory
3. Right-click `nonfiction-v0.12.7.zip`
...
tar -xf nonfiction-v0.12.7.zip
```

**macOS/Linux:**
```bash
cd /path/to/my-book
unzip nonfiction-v0.12.7.zip
```
...
```cmd
cd E:\Projects\my-book
tar -xf nonfiction-v0.12.7.zip --force-local
```

**macOS/Linux (with overwrite):**
```bash
cd /path/to/my-book
unzip -o nonfiction-v0.12.7.zip
```
