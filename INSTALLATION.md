...
Download `nonfiction-v0.13.8.zip` from:
...
tar -xf nonfiction-v0.13.8.zip
```

**macOS/Linux:**
```bash
cd /path/to/my-book
unzip nonfiction-v0.13.8.zip
```
...
```cmd
cd E:\Projects\my-book
tar -xf nonfiction-v0.13.8.zip --force-local
```

**macOS/Linux (with overwrite):**
```bash
cd /path/to/my-book
unzip -o nonfiction-v0.13.8.zip
```
