...
2. Copy `nonfiction-v0.10.3.zip` into this directory
3. Right-click `nonfiction-v0.10.3.zip`
...
```cmd
cd E:\Projects\my-book
tar -xf nonfiction-v0.10.3.zip --force-local
```

**macOS/Linux (with overwrite):**
```bash
cd /path/to/my-book
unzip -o nonfiction-v0.10.3.zip
```
