...
Download `nonfiction-v0.13.1.zip` from:
...
tar -xf nonfiction-v0.13.1.zip
```

**macOS/Linux:**
```bash
cd /path/to/my-book
unzip nonfiction-v0.13.1.zip
```
...
```cmd
cd E:\Projects\my-book
tar -xf nonfiction-v0.13.1.zip --force-local
```

**macOS/Linux (with overwrite):**
```bash
cd /path/to/my-book
unzip -o nonfiction-v0.13.1.zip
```
