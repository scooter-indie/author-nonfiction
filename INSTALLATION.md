...
**AI-Assisted Nonfiction Authoring Framework v0.9.1**
...
Download `nonfiction-v0.9.1.zip` from:
...
tar -xf nonfiction-v0.9.1.zip
```

**macOS/Linux:**
```bash
cd /path/to/my-book
unzip nonfiction-v0.9.1.zip
```
...
```cmd
cd E:\Projects\my-book
tar -xf nonfiction-v0.9.1.zip --force-local
```

**macOS/Linux (with overwrite):**
```bash
cd /path/to/my-book
unzip -o nonfiction-v0.9.1.zip
```
