...
**v0.13.2 Improvement:** Session startup is now 85-90% faster with on-demand loading strategy.
...
*v0.13.2: Lightweight instant-load strategy with on-demand documentation loading*
