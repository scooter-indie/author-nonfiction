...
**v0.13.14 Improvement:** 85-90% faster initialization with on-demand loading strategy.
...
- **v0.13.14:** This initialization loads ~2,000 words (3,000 tokens) - 85-90% reduction from v0.12.10
